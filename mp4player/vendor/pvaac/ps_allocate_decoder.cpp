                          ...
                          UInt32  noSubSamples)
{
    ...
    for (i = 0 ; i < NO_SERIAL_ALLPASS_LINKS ; i++) /*  NO_SERIAL_ALLPASS_LINKS == 3 */
    {
        ...
        /* PATCHED (xprs): row pointers live in the struct, see s_ps_dec.h */
        h_ps_dec->aaaRealDelayRBufferSerQmf[i] = h_ps_dec->aaRealDelayRBufferSerQmfRows[i];
        h_ps_dec->aaaImagDelayRBufferSerQmf[i] = h_ps_dec->aaImagDelayRBufferSerQmfRows[i];
        h_ps_dec->aaaRealDelayRBufferSerSubQmf[i] = h_ps_dec->aaRealDelayRBufferSerSubQmfRows[i];
        h_ps_dec->aaaImagDelayRBufferSerSubQmf[i] = h_ps_dec->aaImagDelayRBufferSerSubQmfRows[i];
